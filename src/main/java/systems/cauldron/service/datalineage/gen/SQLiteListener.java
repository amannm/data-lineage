...
public interface SQLiteListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link SQLiteParser#table_reference}.
	 *
	 * @param ctx the parse tree
	 */
	void enterTable_reference(SQLiteParser.Table_referenceContext ctx);

	/**
	 * Exit a parse tree produced by {@link SQLiteParser#table_reference}.
	 *
	 * @param ctx the parse tree
	 */
	void exitTable_reference(SQLiteParser.Table_referenceContext ctx);
